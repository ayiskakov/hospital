...
erbolat@hospital.com	Erbolat	Yerlanov	2000	188456789	Germany
\.
...
--
-- Name: idx pathogen; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "idx pathogen" ON public.disease USING btree (pathogen);
